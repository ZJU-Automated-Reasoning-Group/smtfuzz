...
ALL_OPS = list(set(CORE_OPS + NUMERICAL_OPS + INT_OPS + REAL_OPS + REAL_INTS + EQ + STRING_OPS + ARRAY_OPS + BV_OPS +
                   FP_OPS + Quantifiers))
CONNECTIVE_OPS = [NOT, AND, IMPLIES, OR, XOR]
OPERATOR_OPS = list(set(NUMERICAL_OPS + INT_OPS + REAL_OPS + REAL_INTS + EQ + STRING_OPS + ARRAY_OPS + BV_OPS +
                        FP_OPS + [EQUAL, DISTINCT, ITE]))
QUANTIFIER_OPS = Quantifiers

ALL_OP_DICT = dict()
for index, eachOP in enumerate(ALL_OPS):
    ALL_OP_DICT[eachOP] = index

OPERATOR_OP_DICT = dict()
for index, eachOP in enumerate(OPERATOR_OP_DICT):
    OPERATOR_OP_DICT[eachOP] = index
