...
Logic_ = (Keyword('QF_LIA') | Keyword('QF_NIA') | Keyword('QF_NRA') | Keyword('QF_NIRA') | Keyword(
    'QF_NRA_ODE') | Keyword('QF_LRA') | Keyword('QF_RDL') | Keyword('ALL') | Keyword('QF_S') | Keyword(
    'QF_SLIA') | Keyword('QF_IDL') | Keyword('QF_LIRA'))

TRUE_ = Keyword('true')
FALSE_ = Keyword('false')

Type_ = (Keyword('Real') | Keyword('Int') | Keyword('Bool') | Keyword('Binary') | Keyword('String') | Keyword(
    'RegLan') | Keyword('(RegEx String)'))
lp = Literal('(')
rp = Literal(')')
