...
class MutantGenerator(object):
    def __init__(self, seed_data, solver_data, formula_data, file_data, info, max_iteration, mode, experiment,
                 debug=None):
        ### Seed Information 
    ...
    def gen_string_term(self, depth):
        ...
        if self.solver == "cvc" and self.mode != "nospec":
            string_op += ["str.update", "str.rev", "str.to_lower", "str.to_upper", "str.replace_re", "str.replace_all",
                          "str.replace_re_all"]
    ...
    def prev_clear(self):
        ...
        self.v = 0
        self.t_var_list = list(self.seed_var["Real"]) + list(self.seed_var["Bool"]) + list(self.seed_var["Int"]) + list(
            self.seed_var["String"])
        self.mutant_ast = None
        self.mutant_term_ast = None
    ...
    def eval(self, op, E, T):
        ...
        elif op in ["tanh", "cosh", "sinh", "arctan2", "atan2", "arctan", "atan", "arccos", "acos", "arcsin", "asin",
                    "tan", "cos",
