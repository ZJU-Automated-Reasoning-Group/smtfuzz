...
class TheoryBridge:
    def __init__(self):
        self.conversion_map = {
            "str_len": {"from": Theory.STRING, "to": Theory.INTEGER, "function": "str.len", "type": ConversionType.LENGTH},
            "str_to_int": {"from": Theory.STRING, "to": Theory.INTEGER, "function": "str.to_int", "type": ConversionType.CONVERSION},
            "str_from_int": {"from": Theory.INTEGER, "to": Theory.STRING, "function": "str.from_int", "type": ConversionType.CONVERSION},
            "set_card": {"from": Theory.SET, "to": Theory.INTEGER, "function": "card", "type": ConversionType.LENGTH},
            "bag_card": {"from": Theory.BAG, "to": Theory.INTEGER, "function": "bag.card", "type": ConversionType.LENGTH},
            "int_to_real": {"from": Theory.INTEGER, "to": Theory.REAL, "function": "to_real", "type": ConversionType.CONVERSION},
            "real_to_int": {"from": Theory.REAL, "to": Theory.INTEGER, "function": "to_int", "type": ConversionType.CONVERSION},
            "bv_to_nat": {"from": Theory.BITVECTOR, "to": Theory.INTEGER, "function": "bv2nat", "type": ConversionType.CONVERSION},
            "int_to_bv": {"from": Theory.INTEGER, "to": Theory.BITVECTOR, "function": "int2bv", "type": ConversionType.CONVERSION},
            "fp_to_sbv": {"from": Theory.FLOATINGPOINT, "to": Theory.BITVECTOR, "function": "fp.to_sbv", "type": ConversionType.CONVERSION},
            "fp_to_ubv": {"from": Theory.FLOATINGPOINT, "to": Theory.BITVECTOR, "function": "fp.to_ubv", "type": ConversionType.CONVERSION},
            "real_to_fp": {"from": Theory.REAL, "to": Theory.FLOATINGPOINT, "function": "to_fp", "type": ConversionType.CONVERSION},
            "fp_to_real": {"from": Theory.FLOATINGPOINT, "to": Theory.REAL, "function": "fp.to_real", "type": ConversionType.CONVERSION},
        }
    ...
    def get_random_conversion(self, from_theory: Optional[Theory] = None, to_theory: Optional[Theory] = None) -> Optional[str]:
